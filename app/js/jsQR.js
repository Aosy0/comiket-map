...
var possibleDimensions = [
    [17, 21, 25, 29, 33, 37, 41, 45, 49, 53, 57, 61, 65, 69, 73, 77, 81, 85, 89, 93, 97, 101, 105, 109, 113, 117, 121, 125, 129, 133, 137, 141, 145, 149, 153, 157, 161, 165, 169, 173, 177],
    [],
    [],
    [],
];
...
function findPossibleDimensions(histogram, minCount, maxCount) {
    ...
    possibleDimensions.sort(function (a, b) { return a - b; });
...
function locate(matrix) {
    var _loop_1 = function (squareSizeLevel) {
        ...
        var _a = findMinMaxFromHistogram(histogram), min = _a.min, max = _a.max;
        ...
        if (possibleDimensions.length >= 3) {
            possibleDimensions.sort(function (a, b) { return a.position - b.position; });
